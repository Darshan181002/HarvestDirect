...
function TermsAndConditions() {
  return (
    <>
      <Helmet>
        <title>Terms &amp; Conditions | Harvest Direct</title>
        <meta
          name="description"
          content="Read the terms and conditions for using Harvest Direct’s B2B food supply chain waitlist and platform. Find your rights, responsibilities, and legal information here."
        />
        <link rel="canonical" href="https://harvestdirect.vercel.app/terms" />
      </Helmet>
      <div className="legal-page">
        <div className="legal-container">
          <h1>Terms &amp; Conditions (T&amp;C)</h1>
